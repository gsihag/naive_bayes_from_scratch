...
def naive_bayes(training_set,test_set, target):
    """
    Parameters:
    ...
    # training data set. Assumes 1 column 
    ...
    no_of_attributes = no_of_columns_train - 1
    actual_class_column = training_set.columns.get_loc(target)
    ...
    predicted_class_column = no_of_columns_test - 1
    ...
    for col in range(0, no_of_attributes):
        ...
        unique_attribute_values_df = unique_attribute_values_df.dropna()
        #print(unique_attribute_values_df)
 
        # Create a Numpy array containing the unique values in the column
        unique_attribute_values_np = unique_attribute_values_df.unique()
        #print(unique_attribute_values_np)
    ...
    y_pred = predictions['Predicted Class']
  
    # Return statement
    return  y_true, y_pred, learned_model, no_of_instances_test 
    ####################### End Testing Phase #################################
